        ...
        $builder
            ...
            ->add('couverture', FileType::class, [
                /* l'option "mapped" avec la valeur false permet de préciser que le champ
                    ne sera pas lié à une propriété de l'objet utilisé pour afficher le 
                    formulaire  */
                "mapped" => false,
                "required" => false
            ])
            ...
            ->add("genres", EntityType::class, [
                ...
                "expanded"      => true,         // permet de choisir comment le champ va être affiché (checkbox, radio buttons...)
                "attr"          => [
                    "class" => "cac"
                ]
            ])

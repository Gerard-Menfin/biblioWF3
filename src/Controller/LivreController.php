...
class LivreController extends AbstractController
{
    ...
    public function add(Request $request, LivreRepository $livreRepository): Response
    {
        /**
            ...
            Par exemple, pour savoir tester la méthode HTTP de la requête, 
        ...
        */
        ...
        if( $request->isMethod("POST") ) {
            ...
            /**
                On instancie un objet d'une classe Entity. C'est à partir de cet objet qu'on va pouvoir enregistrer en bdd.
            */
            $livre = new Livre;
            ...
            /**
                ...
                La méthode 'save' permet de faire les requêtes INSERT INTO et UPDATE. 
                    ...
                    Le 2ème argument doit être égale à true pour que la requête soit vraiment exécutée (sinon elle est mise en attente)
             */
    ...
    public function edit(int $id, LivreRepository $lr, Request $rq)
    {
        ...
        /**
         La méthode 'handRequest' permet à la variable $form de gérer les informations venant 
         de la requête HTTP grâce à l'objet Request passé en argument.
         */

 ...
 */
final class Version20221220153320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE emprunt (id INT AUTO_INCREMENT NOT NULL, abonne_id INT NOT NULL, livre_id INT NOT NULL, sortie DATE NOT NULL, retour DATE DEFAULT NULL, INDEX IDX_364071D7C325A696 (abonne_id), INDEX IDX_364071D737D925CB (livre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
